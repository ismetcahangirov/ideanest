...
class LedgerReconciliationTests {
    ...
    void theJobDoesNotThrowOverAFinding() {
        ...
        LedgerReconciliationJob job = new LedgerReconciliationJob(
                reconciliation,
                new PaymentProperties(null, null, null, null, new PaymentProperties.Reconciliation("-"), null, null));
    ...
    void theScheduleHasADefault() {
        ...
        assertThat(new PaymentProperties(null, null, null, null, null, null, null).reconciliation()).isNotNull();
    }
