...
describe('the FAQ tab', () => {
  it('renders the entries in the order the service sent them', () => {
    render(
      <CampaignFaqs
        faqs={[
  ...
  it('gives every question a heading and prints its answer beside it', () => {
    render(<CampaignFaqs faqs={[faq()]} />);
  ...
  it('renders an answer as text, never as markup', () => {
    render(<CampaignFaqs faqs={[faq({ answer: '<img src=x onerror="alert(1)">' })]} />);
   ...
   */
  it('keeps the line breaks in an answer', () => {
    render(<CampaignFaqs faqs={[faq({ answer: 'First this.\n\nThen that.' })]} />);
  ...
  it('says the campaign has answered nothing only when the campaign has answered nothing', () => {
    render(<CampaignFaqs faqs={[]} />);
   ...
   */
  it('is an ordered list, because the order is the creator’s', () => {
    const { container } = render(<CampaignFaqs faqs={[faq({ id: 'a' }), faq({ id: 'b' })]} />);
  ...
  it('hides no answer behind a disclosure', () => {
    const { container } = render(<CampaignFaqs faqs={[faq()]} />);
