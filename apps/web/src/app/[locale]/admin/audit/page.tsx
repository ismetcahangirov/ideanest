...
export const metadata: Metadata = privatePageMetadata({
  title: 'Audit log',
  description: 'Every privileged action the platform has recorded, newest first.',
});
  ...
  return (
    <div className="max-w-[880px]">
      ...
      <p className="mt-2 max-w-[62ch] text-sm text-white/64">
        Who did what, to what, and how it came out. The table is append-only in
        PostgreSQL rather than by convention, so nothing on this page — and nothing in
        the service — can change a row that is already here.
      </p>
