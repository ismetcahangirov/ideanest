...
describe('malformed input', () => {
  ...
  it.each([
    ...
    ['a route that is a URL', { route: '/[locale]/projects/019432f1-2c4a-7bb1-9f7e-0f21b7c9a4d2/back' }],
    ['a route with a query string', { route: '/[locale]/discover?q=watches' }],
    ['a route nobody declared', { route: '/[locale]/admin' }],
