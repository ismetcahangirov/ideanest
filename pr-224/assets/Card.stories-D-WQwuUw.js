...
}`,...x.parameters?.docs?.source},description:{story:`Composed project card — the densest use of the primitive.`,...x.parameters?.docs?.description}}},S=[`Default`,`Variants`,`ProjectCard`]})))()}C();export{y as Default,x as ProjectCard,b as Variants,S as __namedExportsOrder,v as default};